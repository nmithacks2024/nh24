...
//                             <blockquote
//                                 key={i}
//                                 className="instagram-media w-[40px] h-[50px]"
//                                 data-instgrm-captioned
//                                 data-instgrm-permalink={`https://www.instagram.com/p/${post.id}/?utm_source=ig_embed&amp;utm_campaign=loading`}
//                                 data-instgrm-version="12"

//                             >
//                                 <div style={{ padding: '16px' }}>
//                                     <a
//                                         href={`https://www.instagram.com/p/${post.id}/?utm_source=ig_embed&amp;utm_campaign=loading`}
//                                         style={{
//                                             background: '#FFFFFF',
//                                             lineHeight: '0',
//                                             padding: '0 0',
