	...
	return (
		<div className="py-[90px]">
			...
			<div className="mt-16 flex flex-col justify-center items-center text-lg mx-auto">
				...
				<div className="text-white justify-center items-center font-brand-medium text-[2rem] md:text-[3rem] lg:text-[3rem] leading-normal  text-center">
					<div className="hover-1 font-extrabold">PLATINUM</div>
				</div>
				<div className="w-[100%] mt-1 p-4 flex lg:flex-row md:flex-col sm:flex-row flex-wrap justify-evenly items-center cursor-pointer ">
					{PlatinumSponsors.map((PlatinumSponsors) => (
						<CardWrapper className='hover:bg-[#adb5b8]'>
							<a
								href={PlatinumSponsors.URL}
								target="_blank"
			...
			<div className="pt-3 flex flex-col justify-center items-center text-lg ml-auto">
				<div className="text-white text-center justify-center items-center font-brand-medium text-[2rem] md:text-[3rem] lg:text-[3rem] leading-normal mr-10  text-center">
					<div className="hover-1">Community Partners</div>
				</div>
			...
			<div className="flex justify-center items-center">
				<div className="relative max-w-md w-full p-8 bg-white bg-opacity-20 rounded-lg backdrop-blur-md shadow-lg transition duration-300 ease-in-out transform hover:shadow-xl mt-20 xs:mt-[1rem]">
					...
					<button
						className="bg-secondary hover:bg-transparent border-2 border-secondary  hover:text-secondary text-primary font-bold py-2 px-4 rounded inline-flex items-center"
